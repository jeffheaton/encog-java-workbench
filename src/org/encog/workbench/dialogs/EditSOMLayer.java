...
public class EditSOMLayer extends JDialog implements WindowListener,
		ActionListener {
	...
	public EditSOMLayer(final Frame owner) {
		super(owner, true);
		...
		content.add(this.ctrlNormalization = new JComboBox());
		...
		this.ctrlNormalization.setModel(new DefaultComboBoxModel(new String[] {
				"Multiplicative", "Z-Axis" }));
	...
	public NormalizeInput.NormalizationType getResultNormalization() {
		return this.resultNormalization;
	}
	...
	/**
	 * @param resultNormalization
	 *            the resultNormalization to set
	 */
	public void setResultNormalization(
			final NormalizeInput.NormalizationType resultNormalization) {
